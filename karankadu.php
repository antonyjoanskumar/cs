...
-->
    <div class="row">
        ...
        <div class="col-md-4">
            <h4 class="text-center text-primary mb-4">Select a Parish to See Details</h4>
        ...
        <div class="col-md-8" id="church-details">
            <h3 class="text-center text-info" id="church-name">Karankadu Vicariate</h3>
            <div id="church-info" class="border p-4 rounded bg-light">
                <!-- Church details will be loaded dynamically here -->
            <p><strong>Spritual Director:</strong> Rev. Fr. AAAAAAAAAA</p>
            <p><strong>President:</strong> Mr. BBBBBBBBB</p>
            <p><strong>Vice President:</strong> Mr. CCCCCCCCC</p>
            <p><strong>Secretary:</strong> Mrs. DDDDDDD</p>
            <p><strong>Cashier:</strong> Mr. EEEEEEEEEEE</p>
            <p><strong>Total Number of Parishes:</strong> 11</p>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function showChurchDetails(church) {
        ...
        document.getElementById("church-info").innerHTML = `
            <p><strong>Parish:</strong> ${name}</p>
            <p><strong>Spritual Director:</strong> ${director}</p>
